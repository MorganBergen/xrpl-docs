...
1.  install docker
2.  install and build [`rippled`](https://github.com/XRPLF/rippled/blob/master/BUILD.md)

install cmake [cmake toolchain](https://cmake.org/cmake/help/latest/manual/cmake-toolchains.7.html)
...
4.  follow the steps to the `validator-keys-tool`

this project depends on the rippled repository for core signing functionality.  if you have built and install rippled, you can point this project at your installation using `CMAKE_PREFIX_PATH`
